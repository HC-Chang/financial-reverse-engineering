    ...
    <div className="tax-container">
      ...
      <div className="tax-summary card">
        <div className="tax-metric">
          <span className="metric-label">{t('tax.effectiveRate')}</span>
        ...
        <div className="tax-metric">
          <span className="metric-label">{t('tax.estimatedAnnual')}</span>
